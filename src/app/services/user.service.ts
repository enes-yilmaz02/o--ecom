...
export class UserService {
  ...
  getOrders(userId: string): Observable<Users> {
    return this.commonService.get(`${this.usersEndPoint}/${userId}/${this.ordersEndPoint}`);
  }
  ...
  getOrder(userId: string,orderId:string): Observable<Users> {
    return this.commonService.get(`${this.usersEndPoint}/${userId}/${this.ordersEndPoint}/${orderId}`);
  }

   // Belirli bir kullanıcının siparişini id değereine göre güncelleyen fonksiyon
   addOrder(userId: string,orderId:string, body:any): Observable<Users> {
    return this.commonService.post(`${this.usersEndPoint}/${userId}/${this.ordersEndPoint}/${orderId}`, body);
  }
   // Belirli bir kullanıcının siparişini id değereine göre güncelleyen fonksiyon
  updateOrder(userId: string,orderId:string, body:any): Observable<Users> {
    return this.commonService.put(`${this.usersEndPoint}/${userId}/${this.ordersEndPoint}/${orderId}`, body);
  }

  // Belirli bir kullanıcının siparişini id değereine göre güncelleyen fonksiyon
  deleteOrder(userId: string,orderId:string): Observable<Users> {
    return this.commonService.delete(`${this.usersEndPoint}/${userId}/${this.ordersEndPoint}/${orderId}`);
  }

  // Belirli bir kullanıcının favorilerini getiren fonksiyon
  getFavorites(userId: string): Observable<Users> {
    return this.commonService.get(`${this.usersEndPoint}/${userId}/${this.favoritesEndPoint}`);
  }
  ...
  getFavorite(userId: string,favoriteId:string): Observable<Users> {
    return this.commonService.get(`${this.usersEndPoint}/${userId}/${this.favoritesEndPoint}/${favoriteId}`);
  }

  // Belirli bir kullanıcının favorilerine yeni bir favori ekleyen fonksiyon
  addFavorite(userId: string,favoriteId:string, body:any): Observable<Users> {
    return this.commonService.post(`${this.usersEndPoint}/${userId}/${this.favoritesEndPoint}/${favoriteId}`, body);
  }

  // Belirli bir kullanıcının favorisini id değereine göre güncelleyen fonksiyon
  updateFavorite(userId: string,favoriteId:string, body:any): Observable<Users> {
    return this.commonService.put(`${this.usersEndPoint}/${userId}/${this.favoritesEndPoint}/${favoriteId}`, body);
  }

  // Belirli bir kullanıcının siparişini id değereine göre güncelleyen fonksiyon
  deleteFavorite(userId: string,favoriteId:string): Observable<Users> {
    return this.commonService.delete(`${this.usersEndPoint}/${userId}/${this.favoritesEndPoint}/${favoriteId}`);
  }

  // Belirli bir kullanıcının favorilerini getiren fonksiyon
  getCarts(userId: string): Observable<Users> {
    return this.commonService.get(`${this.usersEndPoint}/${userId}/${this.cartsEndPoint}`);
  }

  // Belirli bir kullanıcının favorisini id değerine göre getiren fonksiyon
  getCart(userId: string,cartId:string): Observable<Users> {
    return this.commonService.get(`${this.usersEndPoint}/${userId}/${this.cartsEndPoint}/${cartId}`);
  }

  // Belirli bir kullanıcının favorilerine yeni bir favori ekleyen fonksiyon
  addCart(userId: string,cartId:string, body:any): Observable<Users> {
    return this.commonService.post(`${this.usersEndPoint}/${userId}/${this.cartsEndPoint}/${cartId}`, body);
  }

  // Belirli bir kullanıcının favorisini id değereine göre güncelleyen fonksiyon
  updateCart(userId: string,cartId:string, body:any): Observable<Users> {
    return this.commonService.put(`${this.usersEndPoint}/${userId}/${this.cartsEndPoint}/${cartId}`, body);
  }

  // Belirli bir kullanıcının siparişini id değereine göre güncelleyen fonksiyon
  deleteCart(userId: string,cartId:string): Observable<Users> {
    return this.commonService.delete(`${this.usersEndPoint}/${userId}/${this.cartsEndPoint}/${cartId}`);
  }
